...
#define HRTIM_FREQUENCY_KHZ 450.0f 	// sets the frequency of the PWM output channels maximum frequency (8 bit PWM): 18Mhz (18000.0) SHOULD BE DIVIDABLE BY 2
...
#define MIN_DUTY 	0.01f 	// sets the minimum duty cycle that the regulation can reach, can be left at 0.002
...
#define CURRENT_AVERAGING_FILTER 	0.998f	// koeffizient of current averaging filter 0 = no averaging 1 = infinite averaging
