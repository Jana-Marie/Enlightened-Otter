...
void TSC_Init(void)
{
  ...
  htscs.Init.SpreadSpectrumDeviation  = 32;
  ...
  htscb.Init.SpreadSpectrumDeviation  = 32;
...
void GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_Color, GPIO_PIN_RESET);
  // Change pin mode to output
  GPIO_InitStruct.Pin   = LED_Color;
  ...
  HAL_GPIO_WritePin(GPIOA, SK6812_EN, GPIO_PIN_RESET);

  GPIO_InitStruct.Pin   = SK6812_EN;
